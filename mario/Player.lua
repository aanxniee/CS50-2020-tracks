...
-- checks if the player touches the flag for victory
function Player:victory()
    if self.map:tileAt(self.x + self.width, self.y + self.height).id == BOTTOM_POLE or
    self.map:tileAt(self.x + self.width, self.y + self.height).id == MIDDLE_POLE or
    self.map:tileAt(self.x + self.width, self.y + self.height).id == TOP_POLE or
    self.map:tileAt(self.x, self.y).id == FLAG then
